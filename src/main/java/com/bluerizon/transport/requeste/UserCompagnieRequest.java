...
public class UserCompagnieRequest {
    ...
    public UserCompagnieRequest() {
    }

    public UserCompagnieRequest(String username, String email, String password, String nom, String prenom, String telephone,
                                String adresse, Roles role, Pays pays, Integer nbrCompagnie, Date expirer, boolean active, Compagnies compagnie) {
