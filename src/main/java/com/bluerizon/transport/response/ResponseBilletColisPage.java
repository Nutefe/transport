...
public class ResponseBilletColisPage {
    private Long total;
    ...
    private Long from;
    private Long to;
    private List<BilletColis> data;

    public ResponseBilletColisPage() {
    }
    ...
    public List<BilletColis> getData() {
        return data;
    }

    public void setData(List<BilletColis> data) {
        this.data = data;
    }
}
