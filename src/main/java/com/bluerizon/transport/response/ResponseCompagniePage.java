...
public class ResponseCompagniePage {
    private Long total;
    ...
    private Long from;
    private Long to;
    private List<Compagnies> data;

    public ResponseCompagniePage() {
    }
    ...
    public List<Compagnies> getData() {
        return data;
    }

    public void setData(List<Compagnies> data) {
        this.data = data;
    }
}
