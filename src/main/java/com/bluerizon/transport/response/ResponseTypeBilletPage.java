...
public class ResponseTypeBilletPage {
    private Long total;
    ...
    private Long from;
    private Long to;
    private List<TypeBillets> data;

    public ResponseTypeBilletPage() {
    }
    ...
    public List<TypeBillets> getData() {
        return data;
    }

    public void setData(List<TypeBillets> data) {
        this.data = data;
    }
}
