...
public class ResponseUserCompagniePage {
    private Long total;
    ...
    private Long from;
    private Long to;
    private List<UserCompagnies> data;

    public ResponseUserCompagniePage() {
    }
    ...
    public List<UserCompagnies> getData() {
        return data;
    }

    public void setData(List<UserCompagnies> data) {
        this.data = data;
    }
}
